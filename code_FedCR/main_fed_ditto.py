...
from models.distributed_training_utils_ditto import Client, Server
...
#-----------------------------------------------test--------------------------------------------------------------------
        ...
        if iter % args.test_freq==args.test_freq-1 or iter>=args.epochs-10:
            ...
            for client in clients:
                ...
                results_test, loss_test1 = client.evaluate(data_x=client.tst_x, data_y=client.tst_y, dataset_name=data_obj.dataset)
