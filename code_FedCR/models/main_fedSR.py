...
from models.NetsSR import Model_CMI, Model_CMI_server
...
if __name__ == '__main__':
    ...
    clients = [Client(model=client_model_VIB(args, args.dimZ, args.alpha, args.dataset).to(args.device), args=args, trn_x=data_obj.clnt_x[i],
